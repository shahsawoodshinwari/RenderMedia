  ...
  <form @submit.prevent="onSubmit" class="row justify-content-center g-3">
    ...
    <div class="col-12">
      <div class="position-relative">
        <input v-model="form.email" class="form-control pe-5" name="email"
          :class="{ 'is-invalid': form.invalid('email') }" placeholder="Email address" autocomplete="email" />
    ...
    <div class="col-12">
      <div class="position-relative">
        <input v-model="form.password" class="form-control" name="password"
          :class="{ 'is-invalid': form.invalid('password') }" :type="isPasswordVisible ? 'text' : 'password'"
